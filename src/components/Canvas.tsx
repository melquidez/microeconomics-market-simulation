...
export const Canvas = (props: CanvasProps) => {
    const { sellersRef, buyersRef, animationsRef, round, status, isSellerActive, getEffectiveAsk, drawNonce } = props;
    ...
    useEffect(() => {
        ...
        render();
    }, [status, round, isSellerActive, getEffectiveAsk, drawNonce, sellersRef, buyersRef, animationsRef]);
